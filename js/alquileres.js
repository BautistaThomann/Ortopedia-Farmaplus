    ...
    const contenido = `
        ...
        <head>
            ...
            <style>
                ...
                .col { width: 45%; display: inline-block; vertical-align: top; }
        ...
        <body>
            ...
            <hr>
            <p>Gracias por confiar en nosotros | División Ortopedia <br> <strong>Farmacia Farmaplus</strong></p>
        </body>
        </html>
    `;
...
if (sessionStorage.getItem("recordarImpresion") === "true") {
    Swal.fire({
        position: "top-end",
        icon: "info",
        title: "Recordá imprimir el contrato de alquiler",
        showConfirmButton: false,
        timer: 2500
    });

    sessionStorage.removeItem("recordarImpresion");
}
